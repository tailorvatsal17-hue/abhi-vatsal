...
exports.signup = (req, res) => {
    ...
    User.findByEmail(email, (err, data) => {
        ...
        bcrypt.hash(password, 10, (err, hash) => {
            ...
            db.query("INSERT INTO otps (email, otp, user_data) VALUES (?, ?, ?)", [email, otp, JSON.stringify(user)], (err, result) => {
                if (err) {
                    return res.status(500).send({
                ...
                const mailOptions = {
                    ...
                    to: email,
                    subject: 'Email Verification OTP - Local Service Provider',
...
exports.verifyOtp = (req, res) => {
    ...
    db.query("SELECT * FROM otps WHERE email = ? AND otp = ? ORDER BY created_at DESC LIMIT 1", [email, otp], (err, results) => {
